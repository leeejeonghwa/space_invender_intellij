...
public class AlienEntity extends Entity {
	/** The speed at which the alient moves horizontally */ // 에일리언이 수평으로 이동하는 속도
	...
	/** The frame duration in milliseconds, i.e. how long any given frame of animation lasts */ //각 프레임이 얼마 동안 보여질지를 결정하는 프레임 지속 시간 (밀리초)
